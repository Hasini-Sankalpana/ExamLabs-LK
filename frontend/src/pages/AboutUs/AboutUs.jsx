    ...
    const handleScroll = () => {
      ...
      aboutSections.forEach(section => {
        ...
        if (rect.top < window.innerHeight && rect.bottom >= 0) {
          section.querySelector('.about-info, .about-infoo').classList.add('visible');
          section.querySelector('.about-img, .about-imgg').classList.add('visible');
        } else {
          section.querySelector('.about-info, .about-infoo').classList.remove('visible');
          section.querySelector('.about-img, .about-imgg').classList.remove('visible');
        }
      });
    };
